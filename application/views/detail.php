    ...
    <div class="container-fluid position-relative d-flex align-items-center justify-content-between">
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li><a href="<?= base_url('tampil/services') ?>">Services</a></li>
  ...
  <main class="main">
     ...
     <nav class="breadcrumbs">
        <div class="container">
          <ol>
            ...
            <li class="current fs-4">Details</li>
          </ol>
        </div>
      </nav>
     </div>
    ...
    <section id="gallery-details" class="gallery-details section">
      ...
      <div class="container " data-aos="fade-up">
        ...
        <div class="">
            <img src="<?= base_url('uploads/galeri/'.$galeri->gambar) ?>" class="thumbnail" style="display: block; margin:auto;" alt="">
        ...
        <div class="row justify-content-between gy-4 mt-4">
          ...
          <div class="col-lg-3" data-aos="fade-up" data-aos-delay="100">
            <div class="portfolio-info">
              ...
              <ul>
                <li><strong>Category</strong> <?= $galeri->kategori ?></li>
                <li><strong>Client</strong> <?= $galeri->client ?></li>
                <li><strong>Project date</strong> <?= $galeri->tgl ?></li>
              </ul>
            </div>
          </div>
